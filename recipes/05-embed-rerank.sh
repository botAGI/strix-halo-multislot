...
# ГРАБЛЯ: дефолт --parallel у llama-server равен -1 (auto), и auto на сборках
# 2026 года резолвится в 4 слота (хардкод в server.cpp). Сервер без флага уже
# крутит 4 слота — проверяйте /props → total_slots, а не список флагов.
